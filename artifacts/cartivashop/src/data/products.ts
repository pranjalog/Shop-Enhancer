...
export const products: Product[] = [
  ...
  },
  {
    ...
    images: [
      "/products/tea-collection-1.jpg",
      "/products/tea-collection-2.jpg",
    ],
    category: "Nutrition",
  ...
  },
  {
    ...
    featured: true,
    specs: {
      Includes: "Massager, Heating Belt, Roll-On",
      Savings: "Over 60%",
  ...
  },
  {
    ...
    originalPrice: 999,
    description:
      "Upgrade your morning ritual with the CartivaCare Electric Milk Frother. This handheld 3-speed frother creates perfectly silky foam for lattes, cappuccinos, herbal teas, and wellness drinks in seconds. Ergonomically designed with a detachable whisk head for easy cleaning. USB-C rechargeable with up to 90 minutes of continuous use. Crafted from food-grade stainless steel — safe, durable, and stylish.",
    shortDescription:
      "3-speed electric milk frother with USB-C charging. 90-minute battery life.",
    images: [
      "/products/frother-1.jpg",
      "/products/frother-2.jpg",
      "/products/frother-3.jpg",
    ],
    category: "Kitchen & Home",
    tags: ["featured", "kitchen", "home", "wellness"],
    rating: 4.6,
    reviewCount: 318,
    inStock: true,
    featured: true,
    ...
    specs: {
      ...
      "Whisk Head": "Detachable for easy cleaning",
      Weight: "95g",
      "What's Included": "Frother, charging cable, whisk head",
    },
  },
  {
    id: "10",
    ...
    originalPrice: 1799,
    description:
      "Meet the CartivaPro 3-in-1 PocketVac — the world's most compact and versatile mini vacuum cleaner. Designed for desks, car interiors, keyboards, and tight spaces, it delivers powerful suction in a pocket-sized body. Three modes: Standard Suction, Turbo Boost, and Blow Mode. Folds flat for easy storage and charges via USB-C. The removable dust cup is washable and transparent so you can see when it needs emptying. Perfect for home, office, or travel.",
    shortDescription:
      "Mini 3-in-1 portable vacuum: suction, turbo, and blow modes. Foldable & USB-C charged.",
    images: [
      "/products/pocketvac-1.jpg",
      "/products/pocketvac-2.jpg",
      "/products/pocketvac-3.jpg",
    ],
    category: "Kitchen & Home",
    tags: ["featured", "kitchen", "home", "portable"],
    rating: 4.5,
    reviewCount: 214,
    inStock: true,
    featured: true,
    ...
    specs: {
      "Suction Modes": "3 (Standard, Turbo Boost, Blow)",
      Charging: "USB-C",
      "Battery Life": "Up to 30 minutes",
      "Dust Cup": "Transparent, removable & washable",
      Design: "Foldable, pocket-sized",
      Weight: "180g",
      "What's Included": "PocketVac, USB-C cable, 3 nozzle attachments, carry pouch",
    },
  },
];
